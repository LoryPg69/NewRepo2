...
{
    using global::LaPiadinereia.API.Dtos;
    using global::LaPiadinereia.API.Models;
    using global::LaPiadinereia.API.Services.IngredientDataService;
    using global::LaPiadinereia.API.Services.ProductDataService;

    namespace LaPiadinereia.API.Services.IngredientDataService
    {
        public class ItemRepository : IIngredientDataService
        {

            IProductDataService _productDataService;

            public ItemRepository(IProductDataService productDataService)
            {
